...
<body>
    <div class="container my-5">
        <div class="d-flex flex-row-reverse bd-highlight">
            <div class="p-2 bd-highlight"><a href="{{ route('student_form.export') }}" class="btn btn-primary">Export PDF</a></div>
            <div class="p-2 bd-highlight"><a href="{{ route('student_form.index') }}" class="btn btn-secondary">Back</a></div>
          </div>
