<x-app-layout>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mb-6">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        ...
                        <form method="POST" class="w-full" id="student-form">
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mt-5 border border-dark px-5 py-3">
                            <h6 class="text-end pb-5 font-bold text-gray-800 leading-tight">
                                {{ $studentForm->name }} <br>
                                {{ $studentForm->date->format('Y-m-d') }}
                            </h6>
                            <h6 class="pb-3 font-bold text-gray-800 leading-tight">{{ $studentForm->title }}</h6>
    ...
    @section('script')
    <script src="{{ mix('js/student_form.js') }}"></script>
